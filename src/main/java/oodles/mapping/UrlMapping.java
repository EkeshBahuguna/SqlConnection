...
public class UrlMapping {
	...
	public static final String REGISTER = ACCOUNTS_API_V1 + "/register";
		...
		public static final String ACTIVATE_OR_DEACTIVATE_ACTIVITY = ACCOUNTS_API_V1 + "/update_activity";
		public static final String GET_ACTIVITY = ACCOUNTS_API_V1 + "/activity";
		public static final String GET_ACTIVE_ACTIVITY = ACCOUNTS_API_V1 + "/active_roles";
		public static final String GET_ACTIVITY_BY_ID = ACCOUNTS_API_V1 + "/role/id";
		public static final String GET_ACTIVITY_BY_NAME = ACCOUNTS_API_V1 + "/role/name";
